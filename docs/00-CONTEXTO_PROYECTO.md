...
*   **Fase 5 (Frontend de Negocio & Pruebas E2E):** 🚧 **En curso — Sprint 1: Autenticación, Layout Shell y CRUDs Maestros**. Consumo de la API REST desde la interfaz React por parte de los componentes de negocio (catálogo interactivo, creación de pedidos, gestor de importaciones) y automatización de pruebas de extremo a extremo (E2E) con Playwright [100, 101]. Ver [`docs/04-SPRINTS.md`](04-SPRINTS.md) para la planificación detallada.
